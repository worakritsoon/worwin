      ...
      <div class="col-md-12">
        <div class="main-timeline">
          <a href="/ionic/Timeline" class="timeline">
            <div class="timeline-icon"><i class="fa fa-globe" /></div>
          ...
          <a href="/ionic/Timeline" class="timeline">
            <div class="timeline-icon"><i class="fa fa-rocket" /></div>
            <div class="timeline-content">
          ...
          <a href="/ionic/Timeline" class="timeline">
            <div class="timeline-icon"><i class="fa fa-briefcase" /></div>
            <div class="timeline-content">
              <h3 class="title">Web Designer</h3>
              <p class="description">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit.
          ...
          <a href="/ionic/Timeline" class="timeline">
            <div class="timeline-icon"><i class="fa fa-mobile" /></div>
            <div class="timeline-content">
              <h3 class="title">Web Developer</h3>
              <p class="description">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit.
          ...
          <div class="main-timeline6">
            ...
            <div class="timeline">
              <div class="timeline-content">
                <span class="year">2017</span>
                <div class="content-inner">
                  <span class="icon"> <i class="fa fa-rocket" /> </span>
                  <h3 class="title">Web Developer</h3>
                  <p class="description">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Integer malesuada tellus lorem, et condimentum neque commodo
            ...
            <div class="timeline">
              <div class="timeline-content">
                <span class="year">2016</span>
                <div class="content-inner">
                  <span class="icon"> <i class="fa fa-briefcase" /> </span>
                  <h3 class="title">Web Designer</h3>
                  <p class="description">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Integer malesuada tellus lorem, et condimentum neque commodo
            ...
            <div class="timeline">
              <div class="timeline-content">
                <span class="year">2015</span>
                <div class="content-inner">
                  <span class="icon"> <i class="fa fa-mobile" /> </span>
                  <h3 class="title">Web Developer</h3>
                  <p class="description">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Integer malesuada tellus lorem, et condimentum neque commodo
      ...
      <div class="col-md-12">
        <div class="main-timeline9">
          ...
          <div class="timeline">
            <div class="timeline-content">
              <div class="circle">
                <span> <i class="fa fa-rocket" /> </span>
              </div>
              <div class="content">
          ...
          <div class="timeline">
            <div class="timeline-content">
              <div class="circle">
                <span> <i class="fa fa-briefcase" /> </span>
              </div>
              <div class="content">
      ...
      <div class="main-timeline10">
        ...
        <div class="col-md-3 col-sm-6 timeline">
          <div class="timeline-inner">
            ...
            <div class="timeline-icon"><i class="fa fa-camera" /></div>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="col-md-12">
        <div class="main-timeline12">
          <div class="col-md-2 col-sm-4 timeline">
            <span class="timeline-icon"> <i class="fa fa-key" /> </span>
            <div class="border" />
            <div class="timeline-content">
